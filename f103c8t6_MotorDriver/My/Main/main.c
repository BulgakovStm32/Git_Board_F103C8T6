...
#define ENCODER_STEP (36000.0 / (65535))//Шаг энкодера. Энкодер 17 битный.При выравнивании Старший бит теряется => код получается 16 бит.
...
//*******************************************************************************************
//*******************************************************************************************
//Получение токов в фазах двигателя.
...
PhaseCurrent_t PhaseCurrentStr;
//************************************************************
//************************************************************
//Измерение тока в фазах.
void PhaseCurrent_Meas(void){
...
//************************************************************
//************************************************************
//Преобразование Эдит Кларк.
void ClarkeTransform(float Ia, float Ib, float Ic, AlphaBetaSystem_t *alphaBetta){

	alphaBetta->I_alpha = Ia;
	alphaBetta->I_beta  = (Ib - Ic) / _SQRT3;
}
//------------------------------------------------------------
//Обратное преобразование Эдит Кларк.


//------------------------------------------------------------
//Прямое преообразование Парка.
