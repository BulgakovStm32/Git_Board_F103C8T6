...
static I2C_TypeDef *_ds1307_i2c;
...
static void DS1307_SetRegByte(uint8_t regAddr, uint8_t val){
	...
	I2C_Write(_ds1307_i2c, DS1307_I2C_ADDR << 1, regAddr, &val, 2);
}
//**********************************************************
/**
...
static uint8_t DS1307_GetRegByte(uint8_t regAddr){
	...
	I2C_Read(_ds1307_i2c, DS1307_I2C_ADDR<<1, regAddr, &val, 1);
	return val;
}
//**********************************************************
/**
...
void DS1307_SetDayOfWeek(uint8_t dayOfWeek){
	...
	//DS1307_SetRegByte(DS1307_REG_DOW, dayOfWeek);
}
//**********************************************************
/**
...
void DS1307_SetTimeAndCalendar(DS1307_TimeCalendar_t *time){
	...
	//Именно в такой последовательности устанавливать время
	DS1307_SetSecond(time->sec);
...
void DS1307_GetTimeAndCalendar(DS1307_TimeCalendar_t *time){
	...
	time->dayOfWeek = DS1307_GetDayOfWeek();
...
//**********************************************************
/**
 * @brief Установка флага регистра статуса.
 * @param
 */
void DS1307_SetStatusFlag(uint8_t flag){

	uint8_t flagsTemp = DS1307_GetRegByte(DS1307_REG_STATUS) | flag;

	DS1307_SetRegByte(DS1307_REG_STATUS, flagsTemp);
}
//**********************************************************
/**
 * @brief Сброс состояния флага регистра статуса.
 * @param
 */
...
//**********************************************************
/**
 * @brief Чтение состояния флага регистра статуса.
 * @param
 */
uint8_t DS1307_GetStatusFlag(uint8_t flag){

	return(DS1307_GetRegByte(DS1307_REG_STATUS) & flag);
}
//*******************************************************************************************
//*******************************************************************************************
#ifdef __cplusplus
