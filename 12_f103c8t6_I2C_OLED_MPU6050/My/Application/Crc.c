...
const volatile uint16_t Crc16Table[256] =  {
...
uint16_t CRC16_FastCalculate(uint8_t *pBlock, uint32_t len){
	...
	while(len--)
	{
		crc = (crc >> 8) ^ Crc16Table[(crc & 0xFF) ^ *pBlock++];
	}
	//return (uint16_t)( ((crc & 0x00FF)<<8) | ((crc & 0xFF00)>>8));
	return crc;
}
//*******************************************************************************************
//*******************************************************************************************
...
//**********************************************************
//Расчет CRC каждого байта.
uint8_t CRC8_ForEachByte(uint8_t byte, uint8_t oldCrc){

	return Crc8Table[oldCrc ^ byte];
}
//**********************************************************
...
const uint8_t Crc8Table_OneWire[256] = {
