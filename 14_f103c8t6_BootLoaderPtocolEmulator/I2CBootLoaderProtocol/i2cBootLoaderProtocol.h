...
//Интерфейс        			: I2C (I2C1 или I2C2 - зависит от устройства)
...
#define APP_PROGRAM_START_ADDR	(uint32_t)(FLASH_BASE + BOOT_SIZE + APP_CONDITION_SIZE)  //начальный адрес приложения
//**********************************
...
uint8_t  BL_HOST_Cmd_WM(uint32_t addr, uint8_t* wrBuf, uint32_t size);
