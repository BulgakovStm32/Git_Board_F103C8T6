...
static uint32_t  videoBufferSize = 0; //
...
//*******************************************************************************************
//*******************************************************************************************
uint32_t SSD1306_Init(uint32_t lcdType, uint8_t *videoBuf, uint32_t videoBufSize){
...
//	memset(SSD1306_Buffer, (color == SSD1306_COLOR_BLACK) ? 0x00 : 0xFF, sizeof(SSD1306_Buffer));
	...
	memset(pVideoBuffer, (color == SSD1306_COLOR_BLACK) ? 0x00 : 0xFF, videoBufferSize);
}
//***********************************************************************
